...
Used when checkpointing intermediate files that can be removed immediately (e.g., files generated by hail).
Used for all RMC-relevant temporary files, including files for missense badness and MPC.
"""
